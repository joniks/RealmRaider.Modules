# Sylvan Encounter Pacing

This no-engine package supplies three immutable pacing recipes keyed only by the
exact cached starter-layout IDs. Ancient Crossroads records an optional Wolf
dead-end plus Root-versus-Moonwell approaches; Forked Canopy records a high
Wolf-and-Root route against a Moonwell route; Serpent Roots records the linear
...
persistence, UI, and every Unity interaction.
